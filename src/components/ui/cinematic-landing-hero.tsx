...
const INJECTED_STYLES = `
  ...
  .premium-depth-card {
      background: linear-gradient(145deg, #FA812F 0%, #B35C21 100%);
      box-shadow: 
...
export function CinematicHero({ 
  ...
  tagline2 = "One Student at a Time.",
  cardHeading = "Unified Education Platform.",
  cardDescription = <><span className="text-white font-semibold">My Vidyon</span> provides a comprehensive suite of tools for students and institutions to manage attendance, assignments, and academic progress with ease.</>,
  metricValue = 92,
  metricLabel = "Attendance %",
  ctaHeading = "Join the Platform.",
  ctaDescription = "Experience the future of education management. Access your dashboard, track your progress, and stay connected.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-screen h-screen overflow-hidden flex items-center justify-center bg-[#FAB12F] text-foreground font-sans antialiased", className)}
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none" style={{ perspective: "1500px" }}>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            {/* 1. TOP (Mobile) / RIGHT (Desktop): BRAND LOGO */}
            <div className="card-right-text gsap-reveal order-1 lg:order-3 flex justify-center lg:justify-end z-20 w-full">
              <img 
                src="/logo.png" 
                alt={brandName} 
                className="h-20 md:h-32 lg:h-48 object-contain drop-shadow-2xl" 
              />
            </div>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                >
                  ...
                  <div className="absolute inset-[7px] bg-[#050914] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    {/* App Interface: Student Dashboard */}
                    <div className="relative w-full h-full pt-12 px-4 pb-8 flex flex-col bg-[#F8FAFC] text-slate-900 overflow-y-auto scrollbar-hide">
                      {/* Header */}
                      <div className="phone-widget flex justify-between items-center mb-6">
                        ...
                        <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center border border-slate-200">
                          <svg className="w-4 h-4 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" /></svg>
                        </div>
                      </div>

                      {/* Institution Card */}
                      <div className="phone-widget bg-white rounded-2xl p-4 shadow-sm border border-slate-100 mb-6 flex justify-between items-center">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-xl bg-orange-50 flex items-center justify-center border border-orange-100">
                            <span className="text-orange-500 font-bold text-xs">SSS</span>
                          </div>
                          <div>
                            <h4 className="text-xs font-bold text-slate-800">Story seed Studio</h4>
                            <p className="text-[10px] text-slate-500">Student Portal</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-[#6366F1] font-bold text-lg leading-none">un</div>
                          <p className="text-[8px] font-bold text-orange-400 uppercase mt-1">STUDENT</p>
                          <p className="text-[8px] text-slate-400">Class 3rd - A</p>
                        </div>
                      </div>

                      {/* Welcome Section */}
                      <div className="phone-widget flex justify-between items-start mb-6">
                        <div>
                          <h3 className="text-lg font-bold text-slate-900">Welcome, Kamalesh S!</h3>
                          <p className="text-[10px] text-slate-500">Unified Education Platform Overview</p>
                        </div>
                        <div className="relative">
                          <svg className="w-6 h-6 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>
                          <span className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-full border-2 border-white flex items-center justify-center text-[6px] text-white font-bold">1</span>
                        </div>
                      </div>

                      {/* Quick Services */}
                      <div className="phone-widget mb-6">
                        <h4 className="text-xs font-bold text-slate-800 mb-4">Quick Services</h4>
                        <div className="grid grid-cols-3 gap-3">
                          {[
                            { label: 'Attendance', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', color: 'text-blue-500', bg: 'bg-blue-50' },
                            { label: 'Courses', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', color: 'text-orange-500', bg: 'bg-orange-50' },
                            { label: 'Assignments', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', color: 'text-emerald-500', bg: 'bg-emerald-50' },
                            { label: 'Exams', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', color: 'text-rose-500', bg: 'bg-rose-50' },
                            { label: 'Leave', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', color: 'text-red-500', bg: 'bg-red-50' },
                            { label: 'Grades', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6', color: 'text-amber-500', bg: 'bg-amber-50' },
                          ].map((item, i) => (
                            <div key={i} className="flex flex-col items-center">
                              <div className={cn("w-10 h-10 rounded-2xl flex items-center justify-center mb-1 shadow-sm border border-slate-100", item.bg)}>
                                <svg className={cn("w-5 h-5", item.color)} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={item.icon} /></svg>
                              </div>
                      ...
                      {/* Bottom Nav */}
                      <div className="absolute bottom-0 left-0 right-0 h-14 bg-white border-t border-slate-100 flex justify-around items-center px-6">
                        <div className="flex flex-col items-center">
                          ...
                          <span className="text-[8px] font-bold text-orange-500 mt-1">Home</span>
                        </div>
                        <div className="flex flex-col items-center">
                          ...
                          <span className="text-[8px] font-bold text-slate-400 mt-1">Settings</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            {/* 3. BOTTOM (Mobile) / LEFT (Desktop): PLATFORM TEXT */}
